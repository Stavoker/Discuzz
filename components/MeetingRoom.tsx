...
import { LayoutList, Underline, Users } from 'lucide-react';
            ...
            justify-center gap-5 flex-wrap'>
                ...
                <DropdownMenu>
                    ...
                    <div className='flex items-center'>
                        <DropdownMenuTrigger className='cursor-pointer rounded-[10px] riunded-2xl 
                        bg-[#19232d] px-4 py-2 hover:bg-[#4c535b] '>
                            <LayoutList size={20} className='text-white ' />
                        </DropdownMenuTrigger>
                    </div>

                    <DropdownMenuContent className='border-dark-1 bg-white font-light text-black'>
                ...
                <button onClick={() => setShowParticipants((prev) => !prev)}>
                    <div className='cursor-pointer rounded-2xl px-4 py-2 hover:bg-[#4c535b] bg-[#19232d]'>
